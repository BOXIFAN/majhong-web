...
TRANSLATIONS = {
    "zh": {
        ...
        "experiment.experimental_note": "实验功能：结果仅作参考。已纳入 M-League 常规赛通算的 54 位职业选手官方个人成绩进行拟合；受公开数据缺少逐局明细所限，部分雷达指标为近似推算，不代表官方统计或对牌风的权威评价。",
    ...
    "en": {
        ...
        "experiment.experimental_note": "Experimental: for reference only. Fit against the official regular-season career stats of 54 M-League pros; some radar axes are approximated because per-game details aren't public. Not an official ranking or authoritative style verdict.",
